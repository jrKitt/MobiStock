                ...
                <main className="p-8">
                    ...
                    {loading ? (
                        ...
                        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg">
                                    ...
                                    <div className="flex items-center gap-8">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <select
                                                ...
                                                className="cursor-pointer rounded-lg border-2 border-gray-200 bg-white px-4 py-2.5 text-sm font-medium transition-colors hover:border-gray-300 focus:border-blue-500 focus:ring-0 focus:outline-none"
                                            >
                                                <option value={5}>
                                                    5 รายการ
                                                </option>
                            ...
                            {/* Pagination Controls */}
                            <div className="flex items-center justify-between border-t border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50 p-6">
