import { FiPrinter, FiEdit, FiTrash2, FiX, FiPhone, FiHome } from 'react-icons/fi'

export const PrintIcon = ({ className = "h-4 w-4" }: { className?: string }) => (
...
export const DeleteIcon = ({
    className = "h-4 w-4",
}: { className?: string }) => <FiTrash2 className={className} />

export const CloseIcon = ({
    className = "h-5 w-5",
}: { className?: string }) => <FiX className={className} />
